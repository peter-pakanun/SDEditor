...
> 💡 It is recommended to use the **Autocomplete Popup (Ctrl + I by default)** to insert these tags to speed up your work and ensure consistency.
...
While editing a translation, press the configured shortcut (**Ctrl + I** by default) or **`[`** (left square bracket) to open a popup showing all available Dictionary replacements. This is called the **Autocomplete Popup**.

You can change **Settings → Autocomplete popup shortcut** to **Ctrl + I**, **Ctrl + Space**, or **Disabled**. Ctrl + I is the default because Ctrl + Space can conflict with some operating-system or IME shortcuts. Disabling the keybinding does not disable the `[` trigger. SDEditor also leaves keys to the IME while text composition is active.
...
| Shortcut           | Action                                       |
|--------------------|----------------------------------------------|
| Ctrl + I or [      | Open Autocomplete Popup (Ctrl + I default)   |
...
1. **Ctrl + Click** the keyword in the English text or use the configured autocomplete shortcut to open the Autocomplete Popup, then press **Ctrl + Enter** while selecting the keyword
